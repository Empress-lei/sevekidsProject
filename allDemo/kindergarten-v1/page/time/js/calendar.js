...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define('calendar', ['sevekidsProject/allDemo/kindergarten-v1/page/time/js/jquery'], factory);
    } else if (typeof exports === 'object') {
        module.exports = factory(require('sevekidsProject/allDemo/kindergarten-v1/page/time/js/jquery'));
    } else {
        factory(root.jQuery);
    }
}(this, function($) {
    ...
    Calendar.prototype = {
        ...
        getDaysHtml: function(y, m) {
            ...
            firstWeek = new Date(year, month - 2, 1).getDay() || 7;
            ...
            for (var c = 1; c <= daysNum -7; c++, count++) {
